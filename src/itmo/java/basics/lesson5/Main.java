...
public class Main {
    public static void main(String[] args) {
        System.out.println();
        String text = "Lorem Ipsum 123 - это текст-\"бяка\", часто используемыйвпечати и вэб-дизайне. Бяка является стандартной \"рыбой\" для текстов на латинице с начала XVI века.";
...
// 3.
        System.out.println();
        System.out.println(TextTools.makeCensor(text, "бяка"));
        System.out.println(TextTools.makeCensor(text, "бяка", "***"));
//        4.
        System.out.println();
